...
output: 
  flexdashboard::flex_dashboard:
        orientation: columns
        navbar:
           - { icon: "fa-question-circle", href: "https://www.siildigitalagconsortium.com/", align: right }
        theme:
            bg: "#c7c7c9"
            fg: "#253659"
            primary: "#253659"
...
places <- rgdal::readOGR("C:/Users/gsantiago/Documents/K-State/Senegal-visualizing-data-app/Data", "zonal_stats")
...
h2("This is the raw data: ", style="margin: 10px;")
...
h2 (style="padding: 10px", "Authors: ")
p (style="text-align: justify; padding: 20px", "Ana J.P. Carcedo, Gustavo N. Santiago, Molly E. Brown, Ignacio A. Ciampitti.")
h2 (style="padding: 10px", "How to cite this app: ")
p (style="text-align: justify; padding: 20px"," *Citation of paper *")
h2 (style="padding: 10px", "Contacts: ")
p (style="text-align: justify; padding: 10px", "* Links of Ciampitti webb-site, mine github, Ciampitti's twitter *")
