...
output$productivity <- renderUI({
  ...
  if(!is.null(production_filtered[,3])){
...
output$economic <- renderUI({
  ...
  if(!is.null(economic_filtered[,3])){
...
output$environmental <- renderUI({
  ...
  if(!is.null(environment_filtered[,3])){
...
output$human <- renderUI({
  ...
  if(!is.null(human_filtered[,3])){
    varSelectizeInput("human",
                    h6("Human (choose up to 2 variables)"),
...
output$social <- renderUI({
  ...
  if(!is.null(social_filtered[,3])){
    varSelectizeInput("social",
                    h6("Social (choose up to 2 variables)"),
...
output$dataCor <- renderUI({
  ...
  varSelectizeInput("dataCor",
                    h6("Select what data you want to correlate: (up to 9 variables"),
...
dataInputGraphSIAF <- reactive({
  ...
  choices <- c(productivity, economic, human, social, environmental)
...
<br> <a href = "https://sitoolkit.com/assessment-framework/the-five-domains-of-sustainable-intensification"><img src="SITOOLKIT.svg" height="120" width="120"/></a>
